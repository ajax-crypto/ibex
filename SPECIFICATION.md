...
### 3.15 Destructive Move and Memory Semantics
...
### 3.16 Explicit Type Casting (`as`)
- **Syntax**: `Expr as Type`
- **Semantic Constraints**: Casts are strongly typed and heavily constrained:
  - **Numeric/Primitive**: Allowed symmetrically across integer types, floating point types, enums, and flags. 
